""" 
EditWin class definition : Edit window & console class
...
class EditWin:
    def __init__(self,win,nch,nlin,winx,winy):
        ...
        self.fontedit = CFastfont(win,'Helvetica',14,white,False,False) # name, size, bold,italic
...
#        self.printeditwin('Testing 1,2,3')
    ...
    def echo(self,msg): # print a message to console window
