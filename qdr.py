...
# Developed by J.M.Hoekstra & John McGowan (jmcgowan@inch.com) using WGS'84

def qdrdist(latadeg,lonadeg,latbdeg,lonbdeg):

# calculate direction from A to B [deg] and the distance in meters
...
# Purpose      : Compute LAT/LON of X given TRUE BEARINGs from A and B
#                Distance from A is returned as function value ,but
#                upon ERROR a ZERO function value will be returned.
# Author       : J.M.Hoekstra & John McGowan (jmcgowan@inch.com)
